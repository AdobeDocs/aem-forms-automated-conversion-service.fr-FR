---
title: Présentation de Automated Forms Conversion Service (AFCS)
...
Automated Forms Conversion service (AFCS) s’exécute sur Adobe Cloud. [Configurez le compte Adobe I/O de votre entreprise et connectez votre instance AEM locale](configure-service.md) au service de conversion exécuté sur Adobe Cloud. Pour AEM 6.5 et AEM 6.5 LTS, vous devez activer les composants principaux des formulaires adaptatifs si vous utilisez des modèles et des thèmes basés sur les composants principaux. Voir [Configurer le service](configure-service.md#referencepackage).

### &#x200B;2. Convertir des formulaires PDF en formulaires adaptatifs {#use-the-conversion-service}
